    ...
    <>
      <div className={classes.loading_container}>
        ...
        >
          ...
          <g>
            <g className={classes.pl__ring_rotate}>
              <circle
                className={classes.pl__ring_stroke}
                cx="80"
                cy="80"
                r="72"
                fill="none"
          ...
          <g>
            <g transform="translate(64,28)">
              <g className={classes.pl__arrows} transform="rotate(45,16,52)">
                <path
                  fill="hsl(3,90%,55%)"
