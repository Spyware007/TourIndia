...
import abc from "../../../assets/blogs/avatar.png";

const BlogCard = ({
  title = "Explore the Amazing India",
  mins = "4",
  likes = "4",
  comments = "10",
  avatar = abc,
  ...
  return (
    <>
      <div class={classes.post_card}>
        <div class={classes.avatar}>
          <img className={classes.avatar_image} src={avatar} alt="avatar" />
        </div>
        <a class={classes.title} href="#">
          {title}
        </a>
        <span class={classes.datetime}>{mins} min to read</span>
        <div class={classes.image_preview}>
          <img className={classes.blog_image} src={blogImage} alt="image" />
        </div>
        <div class={classes.comment_like}>
